...
\section{Almacenamiento de documentación (MinIO)}

MinIO se emplea como almacenamiento de objetos compatible con S3 para custodiar artefactos documentales del proyecto (manuales PDF, anexos versionados y evidencias de entrega).

\subsection*{Casos de uso}

\begin{itemize}
\item Publicación de manuales y documentos de soporte en un bucket dedicado.
\item Versionado de entregables técnicos por prefijos y convenciones de nombre.
\item Integración con herramientas de automatización para subida/descarga de artefactos.
\end{itemize}

\subsection*{Parámetros operativos}

\begin{itemize}
\item Endpoint API S3 compatible: \texttt{9000/tcp}.
\item Consola de administración: \texttt{9001/tcp}.
\item Bucket recomendado para documentación: \texttt{atlas-documentacion}.
\item Control de acceso mediante credenciales de servicio y políticas por bucket/prefijo.
\end{itemize}
