...
\item MinIO para almacenamiento de objetos S3 compatible orientado a documentación técnica.
...
\item Configurar variables de entorno para cada servicio (RabbitMQ, MariaDB, Valkey, MinIO y endpoints internos).
\item Levantar servicios de infraestructura compartida (RabbitMQ, MariaDB, Valkey, MinIO y, cuando aplique, Ollama).
...
\item Verificar disponibilidad de MinIO y creación del bucket documental definido por entorno.
...
\item Documentación: endpoint MinIO, bucket destino y prefijo de almacenamiento.
